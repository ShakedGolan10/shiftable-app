  ...
  return (
    <>
      <button onClick={toggleMenu} className="bg-transparent rounded text-xl leading-none hover:no-underline focus:no-underline lg:hidden lg:text-gray-400" type="button">
        <span className={`${styles['navbar-toggler-icon']} inline-block w-8 h-8 align-middle`}></span>
      </button>

      <div className={`basis-full lg:basis-auto ${(menuToggle) ? `${styles['offcanvas-collapse']} ${styles['open']}` : styles['offcanvas-collapse']} lg:flex lg:flex-grow lg:items-center`}>
        <ul className="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
          <li>
            <a className={`${styles['nav-link']} active`} href="#header">Home <span className="sr-only">(current)</span></a>
          </li>
          <li>
            <a className={`${styles['nav-link']}`} href="#features">Features</a>
          </li>
          <li>
            <a className={`${styles['nav-link']}`} href="#details">Details</a>
          </li>
          <li>
            <a className={`${styles['nav-link']}`} href="#pricing">Pricing</a>
          </li>
          <li>
            <a className={`${styles['nav-link']}`} href="#download">Download</a>
          </li>
        </ul>
